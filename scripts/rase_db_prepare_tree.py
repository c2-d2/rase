...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Prepare a tree for RASE. Rename nodes and add names for internal nodes.')
    ...
    parser.add_argument('-n', '--node-col',
            type=int,
            metavar='INT',
            required=True,
            dest='node_col',
    ...
    parser.add_argument('-p', '--phylogroup-col',
            type=int,
            metavar='INT',
            required=True,
            dest='pg_col',
