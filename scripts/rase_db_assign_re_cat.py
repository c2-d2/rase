...
def pseudo_mic_to_interval(pseudo_mic):
    ...
    print("MIC string '{}' could not be parsed. A new regular expression should be added.".format(pseudo_mic) ,file=sys.stderr)
    return (0, float("+inf"))
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Read MICs from a TSV file and assign resistance categories (R / S / NA).")
